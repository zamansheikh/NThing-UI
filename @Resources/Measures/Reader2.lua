...
function Output()
	...
	local Timestamp = SELF:GetOption('Timestamp', '%d %B %Y')
...
Queue['Item'..i..'Day'] = Item.Date and os.date('%d', Item.Date) or ''
Queue['Item'..i..'Month'] = Item.Date and os.date('%b', Item.Date) or ''
